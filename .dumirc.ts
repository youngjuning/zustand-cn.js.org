...
export default defineConfig({
  ...
  themeConfig: {
    ...
    hd: { rules: [] },
    footer: '<a href="/sitemap.xml" target="_blank">站点地图</a> | <a href="https://youngjuning.js.org/zizhudocs" target="_blank">紫竹翻译计划</a> | <a href="https://t.zsxq.com/0fDyODCQs" target="_blank">紫竹赚美刀</a><br/>Made with ❤️ by <a href="https://youngjuning.js.org" target="_blank">洛竹</a>',
  },
  theme: {
    '@c-primary': '#e5743f',
  },
